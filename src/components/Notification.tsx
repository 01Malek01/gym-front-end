      ...
      <div className="container w-96 max-h-96 bg-slate-300 p-3 m-2 rounded-lg shadow-lg overflow-y-auto">
        ...
        {notifications.length > 0 && (
          <button
            ...
            className={`inline-flex items-center gap-2 text-sm my-3 ${
              isMarkingAsRead
          ...
          >
            {isMarkingAsRead && (
              <span className="animate-spin rounded-full h-3 w-3 border-2 border-transparent border-t-current"></span>
            )}
            <span>
